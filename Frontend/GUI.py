...
def SetAssistantStatus(Status):
    with open(rf'{TempDirPath}\AssistantStatus.data', 'w', encoding='utf-8') as file:
        file.write(Status)
    ...
    def SpeechRecogText(self):
        try:
            with open(TempDirectoryPath('AssistantStatus.data'), "r", encoding='utf-8') as file:
                messages = file.read()
                self.label.setText(messages)  # Update the status label
        except Exception as e:
            print(f"Error reading AssistantStatus.data: {e}")
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        title_label = QLabel(" MechautoX AI")  # Updated title
